...
Design thesis: For a technical owner entering active software operations, this surface helps them orient and decide by making identity, portfolio state, and the next inspection action immediately legible. Its visual language comes from one accountable operating spine feeding two execution loops—the geometric structure of a `B`—rather than executive decoration. Identity, state, and commands never move or disappear. The signature move is a five-row solid-spine B integrated with the full operations hierarchy, including state and actions. It remains BOSS as `BOSS · YOUR AI COO`, one status line, and plain commands at narrow width, no color, no motion, or ASCII-only output. We reject nautical imagery, corporate cosplay, giant banners, and ambient spectacle because they compete with live work.
...
Spacing, borders, symbols, and width rules: Five-row `██████╮ / █     │ / ██████┤ / █     │ / ██████╯` B at wide width with a five-cell gap to the copy; no divider or nested borders; `truncateToWidth` and `visibleWidth` gate every line; ASCII fallback uses `[B]` and `>`
Art role, footprint, and opt-out: Identity/orientation only, maximum five mark rows inside a five-row lockup that also carries role, state, and actions; `BOSS_PLAIN=1` or `TERM=dumb` selects the quiet ASCII equivalent; narrow mode removes the mark before content
...
- `TX-C1` — Every masthead line is at most the requested display width and row limits are 5/3/2 at 120/60/50 cells | normal and maximum-content | Unicode/no-color | deterministic rendered frame
...
Wide/default evidence: Actual isolated 80-column Pi TUI, deterministic 120/100/80-column frames, source-rendered 100×30 PNG, and prior unchanged Herdr integration receipts in `docs/evidence/pi-tui-terminal-mark.md`, `docs/evidence/terminal-render.txt`, `docs/evidence/screenshots/default-100x30.png`, and `docs/evidence/herdr-coexistence.md`
Minimum-viewport evidence: Actual isolated 50×12 Pi TUI, deterministic 50-, 32-, and 12-column display-cell checks, and source-rendered 50×12 no-color PNG in `docs/evidence/pi-tui-terminal-mark.md`, `docs/evidence/terminal-render.txt`, and `docs/evidence/screenshots/minimum-50x12-no-color.png`
No-color evidence: Maximum-content ANSI-absence byte receipt and no-color frames in `docs/evidence/terminal-mark-verification.md` and `docs/evidence/terminal-render.txt`
ASCII/plain evidence: ASCII-only 80-column normal/degraded byte receipts plus maximum-content width tests in `docs/evidence/terminal-mark-verification.md` and `docs/evidence/terminal-render.txt`
...
Error/degraded evidence: Tool-missing live discovery, corrected local-controller launch, stale-footer replacement in source, deterministic degraded frame, byte receipt, and source-rendered plain PNG in `docs/evidence/herdr-coexistence.md`, `docs/evidence/terminal-render.txt`, `docs/evidence/terminal-mark-verification.md`, and `docs/evidence/screenshots/degraded-60x12-plain.png`
...
- T1 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
- T2 — PASS — `docs/evidence/pi-tui-terminal-mark.md` `docs/evidence/screenshots/default-100x30.png`
- T3 — PASS — `docs/evidence/herdr-coexistence.md`
- T4 — PASS — `docs/evidence/herdr-coexistence.md`
- T5 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
- T6 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
- T7 — PASS — `docs/evidence/pi-tui-terminal-mark.md` `docs/evidence/terminal-render.txt`
- T8 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
- T9 — PASS — `docs/evidence/herdr-coexistence.md`
- T10 — PASS — `docs/evidence/terminal-render.txt`
- T11 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/screenshots/degraded-60x12-plain.png`
- T12 — PASS — `docs/evidence/terminal-mark-review.md` `docs/evidence/terminal-render.txt`

### Locked-check results

TX-C1 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
TX-C2 — PASS — `docs/evidence/pi-tui-terminal-mark.md` `docs/evidence/screenshots/default-100x30.png`
TX-C3 — PASS — `docs/evidence/pi-tui-terminal-mark.md` `docs/evidence/screenshots/minimum-50x12-no-color.png`
TX-C4 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
TX-C5 — PASS — `docs/evidence/terminal-mark-verification.md` `docs/evidence/terminal-render.txt`
...
Independent reviewer: fresh ephemeral tool-free Pi (`gpt-5.6-sol`, high reasoning), accepted the final terminal mark and surface evidence 2026-08-24
Reviewer report: `docs/evidence/terminal-mark-review.md`
Final verdict: Pass
